...
def get_steph_curry_s_ra_data():
    nba_1 = {'left_shoulder': [323, 733], 'right_shoulder': [408, 775], 'left_elbow': 'NONE', 'right_elbow': [495, 786], 'left_wrist': 'NONE', 'right_wrist': [454, 855], 'left_hip': [343, 538], 'right_hip': [399, 539], 'ball': None, 'Side': 'RIGHT', 'frame': 38}
    nba_2 = {'left_shoulder': [260, 724], 'right_shoulder': [367, 760], 'left_elbow': 'NONE', 'right_elbow': [468, 767], 'left_wrist': 'NONE', 'right_wrist': [419, 843], 'left_hip': [291, 504], 'right_hip': [357, 501], 'ball': None, 'Side': 'RIGHT', 'frame': 81}
    nba_3 = {}
    nba_4 = {'left_shoulder': [66, 656], 'right_shoulder': [-22, 657], 'left_elbow': 'NONE', 'right_elbow': [34, 665], 'left_wrist': [137, 685], 'right_wrist': [77, 743], 'left_hip': [61, 455], 'right_hip': [-1, 449], 'ball': None, 'Side': 'RIGHT', 'frame': 124}
    nba_5 = {'left_shoulder': [249, 692], 'right_shoulder': [345, 737], 'left_elbow': 'NONE', 'right_elbow': [448, 735], 'left_wrist': 'NONE', 'right_wrist': [415, 812], 'left_hip': [273, 486], 'right_hip': [328, 489], 'ball': None, 'Side': 'RIGHT', 'frame': 35}
    nba_6 = {'left_shoulder': [229, 688], 'right_shoulder': [300, 725], 'left_elbow': 'NONE', 'right_elbow': [386, 739], 'left_wrist': 'NONE', 'right_wrist': [370, 797], 'left_hip': [254, 504], 'right_hip': [297, 510], 'ball': None, 'Side': 'RIGHT', 'frame': 22}
    nba_7 = {'left_shoulder': [186, 728], 'right_shoulder': [279, 767], 'left_elbow': 'NONE', 'right_elbow': [369, 782], 'left_wrist': 'NONE', 'right_wrist': [345, 849], 'left_hip': [208, 523], 'right_hip': [266, 521], 'ball': None, 'Side': 'RIGHT', 'frame': 24}
    nba_8 = {'left_shoulder': [287, 682], 'right_shoulder': [340, 701], 'left_elbow': 'NONE', 'right_elbow': [422, 706], 'left_wrist': 'NONE', 'right_wrist': [406, 763], 'left_hip': [289, 499], 'right_hip': [322, 498], 'ball': None, 'Side': 'RIGHT', 'frame': 41}
    nba_9 = {'left_shoulder': [201, 661], 'right_shoulder': [263, 696], 'left_elbow': 'NONE', 'right_elbow': [343, 704], 'left_wrist': 'NONE', 'right_wrist': [337, 760], 'left_hip': [204, 476], 'right_hip': [243, 481], 'ball': None, 'Side': 'RIGHT', 'frame': 24}
    nba_10 = {'left_shoulder': [75, 709], 'right_shoulder': [138, 731], 'left_elbow': 'NONE', 'right_elbow': [222, 735], 'left_wrist': 'NONE', 'right_wrist': [193, 801], 'left_hip': [84, 530], 'right_hip': [120, 529], 'ball': None, 'Side': 'RIGHT', 'frame': 27}
    nba_11 = {'left_shoulder': [75, 488], 'right_shoulder': [91, 494], 'left_elbow': 'NONE', 'right_elbow': [148, 496], 'left_wrist': 'NONE', 'right_wrist': [151, 540], 'left_hip': [97, 364], 'right_hip': [100, 361], 'ball': None, 'Side': 'RIGHT', 'frame': 34}
    nba_12 = {'left_shoulder': [211, 552], 'right_shoulder': [223, 563], 'left_elbow': 'NONE', 'right_elbow': [282, 561], 'left_wrist': 'NONE', 'right_wrist': [263, 620], 'left_hip': [235, 412], 'right_hip': [223, 414], 'ball': None, 'Side': 'RIGHT', 'frame': 7}
    nba_13 = {'left_shoulder': [216, 545], 'right_shoulder': [214, 548], 'left_elbow': 'NONE', 'right_elbow': [264, 560], 'left_wrist': 'NONE', 'right_wrist': [248, 608], 'left_hip': [223, 415], 'right_hip': [220, 415], 'ball': None, 'Side': 'RIGHT', 'frame': 19}
    nba_14 = {'left_shoulder': [169, 556], 'right_shoulder': [140, 554], 'left_elbow': 'NONE', 'right_elbow': [180, 552], 'left_wrist': 'NONE', 'right_wrist': [183, 620], 'left_hip': [177, 415], 'right_hip': [152, 411], 'ball': None, 'Side': 'RIGHT', 'frame': 4}
    nba_15 = {'left_shoulder': [328, 520], 'right_shoulder': [332, 522], 'left_elbow': 'NONE', 'right_elbow': [388, 510], 'left_wrist': 'NONE', 'right_wrist': [394, 565], 'left_hip': [340, 397], 'right_hip': [341, 396], 'ball': None, 'Side': 'RIGHT', 'frame': 41}
    nba_16 = {'left_shoulder': [131, 595], 'right_shoulder': [130, 605], 'left_elbow': 'NONE', 'right_elbow': [177, 601], 'left_wrist': 'NONE', 'right_wrist': [173, 636], 'left_hip': [128, 473], 'right_hip': [128, 473], 'ball': None, 'Side': 'RIGHT', 'frame': 25}
    nba_17 = {'left_shoulder': [297, 647], 'right_shoulder': [298, 647], 'left_elbow': 'NONE', 'right_elbow': [372, 653], 'left_wrist': 'NONE', 'right_wrist': [339, 724], 'left_hip': [324, 459], 'right_hip': [319, 461], 'ball': None, 'Side': 'RIGHT', 'frame': 18}
    
    merged_dict = {}

    for d in [nba_1, nba_2, nba_3, nba_4, nba_5, nba_6, nba_7, nba_8, nba_9, nba_10, nba_11, nba_12, nba_13, nba_14, nba_15, nba_16, nba_17]:
